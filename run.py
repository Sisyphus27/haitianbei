...
def main():
    ...
    parser = argparse.ArgumentParser(description="haitianbei: train / stream-judge")
    ...
    # 模式选择
    parser.add_argument("--mode", choices=["train", "stream-judge"], default="stream-judge",
                        help="运行模式：train / stream-judge")
